...
SOURCE_FOLDER = "./t2m-HumanML3D/texts"  # Change this to your actual folder
DEST_FOLDER = "./t2m-HumanML3D/walking_texts"  # Change this to your filtered folder
OUTPUT_FILE = "./t2m-HumanML3D/t2m-filtered_filenames.txt"  # Output filename list
